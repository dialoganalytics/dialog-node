...
Client.prototype.event = function(name, createdAt, interlocutorDistinctId, properties, callback) {
  this.createEvent({ name: name, created_at: createdAt, id: interlocutorDistinctId, properties: properties }, callback);
};
