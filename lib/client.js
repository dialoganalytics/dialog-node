...
// @param {String} url
// @param {String} id An interlocutor distinct Id provided by the platform or the provider
// @returns {String}
// @see https://docs.dialoganalytics.com/reference/click-tracking/
Client.prototype.link = function(url, id) {
  return this.apiEndpoint + "b/" + this.botId + "/clicks/" + "?id=" + id + "&url=" + encodeURIComponent(url);
};

// @param {String} name Event name
// @param {Number} createdAt Unix datetime in milliseconds
// @param {String} interlocutor_id Interlocutor tied to the event
...
// @param {String} id Interlocutor distinct id
// @param {Object} params
// @param {Function} callback
// @returns {Object}
// @see https://docs.dialoganalytics.com/reference/interlocutor#update
Client.prototype.updateInterlocutor = function(id, params, callback) {
  var options = {
    url: this.apiEndpoint + "b/" + this.botId + "/interlocutors/" + id,
